...
#define DEFAULT_ON_DURATION		10 // Default ON duration of a cycle in milliseconds(ms).
#define DEFAULT_OFF_DURATION	10 // Default OFF duration of a cycle in milliseconds(ms).
#define DEFAULT_PAUSE_DURATION	10 // Default PAUSE duration of a cycle in milliseconds(ms).
